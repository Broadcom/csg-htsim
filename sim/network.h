...
enum RouteStrategy {NOT_SET, SINGLE_PATH, SCATTER_PERMUTE, SCATTER_RANDOM, PULL_BASED, SCATTER_ECMP, ECMP_FIB, ECMP_FIB_ECN, REACTIVE_ECN, ECMP_RANDOM_ECN};
...
typedef enum {IP, TCP, TCPACK, TCPNACK, SWIFT, SWIFTACK, STRACK, STRACKACK, NDP, NDPACK, NDPNACK, NDPPULL, NDPRTS, NDPLITE, NDPLITEACK, NDPLITEPULL, NDPLITERTS, ETH_PAUSE, TOFINO_TRIM, ROCE, ROCEACK, ROCENACK, HPCC, HPCCACK, HPCCNACK} packet_type;
