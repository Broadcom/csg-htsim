...
"3tier_strack_256/rxpps" using ($1):($0*100/8192) w l lw 2 linecolor rgb "red" t "strack, even spray, 256 paths", \
"3tier_strack_rand_256/rxpps" using ($1):($0*100/8192) w l lw 2 linecolor rgb "green" t "strack, random path with ECN, 256 paths",\
