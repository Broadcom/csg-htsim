...
"3tier_notrim_ecn_256/finished" using ($1):($0*100/8192) w l lw 2 lc "red" t "ECN_LB, ECN at 0.5 BDP, 256 paths",\
...
"3tier_notrim_ecn_32/finished" using ($1):($0*100/8192) w l lw 2 lc "purple" t "ECN_LB, ECN at 0.5 BDP, 32 paths"
